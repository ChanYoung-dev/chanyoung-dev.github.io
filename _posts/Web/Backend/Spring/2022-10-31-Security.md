---
permalink: /Java/Spring/LoginBySecurity/
...
만약 사용자가 여러개의 권한을 갖는다는 정책이면 [RolesSpring Security - Role (단일 권한, 복합 권한) ](https://chanyoung-dev.github.io/Java/Spring/Roles/)를 참조
