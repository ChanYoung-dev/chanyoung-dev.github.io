---
permalink: /Java/Spring/SecurityMSA/
...
# 아키텍쳐
- 1.**[Discovery](/Java/Spring/SecurityMSA/#1-discovery)** - 서비스들의 정보를 관리하는 `Eureka Server`
- 2.**[ApiGateWay](https://chanyoung-dev.github.io/Java/Spring/SecurityMSA/#2-apigateway)** - 서비스들을 Routing하는 `Eureka Client`
- 3.**[userService](https://chanyoung-dev.github.io/Java/Spring/SecurityMSA/#3-userservice)**(로그인,회원가입관련 서비스) - `Eureka Client`
